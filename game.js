class TicTacToe {
    ...
    createFireworks() {
        const colors = ['#FF0000', '#00FF00', '#0000FF', '#FFFF00', '#FF00FF', '#00FFFF', '#FFA500', '#FF69B4', '#7CFC00', '#00CED1'];
        ...
        const createFirework = (position, color) => {
            ...
            switch(position) {
                case 'left':
                    firework.style.setProperty('--tx', `${Math.random() * 200}px`);
                ...
                case 'top':
                    ...
                    firework.style.setProperty('--ty', `${Math.random() * 200}px`);
                    break;
                case 'bottom':
                    firework.style.setProperty('--tx', `${Math.random() * 200 - 100}px`);
                    firework.style.setProperty('--ty', `${Math.random() * -200}px`);
